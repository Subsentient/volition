...
#define NODE_STARTUPSCRIPT_DELIMSTART "SLSC://{{LNIIBS_XE::"
#define NODE_STARTUPSCRIPT_DELIMSTART_LENGTH (sizeof NODE_STARTUPSCRIPT_DELIMSTART - 1)
#define NODE_STARTUPSCRIPT_CAPACITY (1024 * 128) //128KiB max script size
